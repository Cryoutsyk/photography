...
public class ${capitalModelName}Controller extends ApplicationController<${capitalModelName}>  {
	/**
	 * 注入Service类对象.
	 */
	 ...
	 *
	 *
	 * @api {GET} /${modelName}/query 查询地址所有数据
	 * @apiVersion 1.0.0
     * @apiName query
     * @apiGroup ${capitalModelName}
     ...
     * @apiParam {${column.javaType}} ${column.beanName} ${column.columnComment}
	 </#list>
     * 
     * @apiExample 调用示例:
     * 	curl -i http://localhost:8080/mars-core/${modelName}/query?format=json&ignore=true&version=v1
     * 
     * @apiSuccess {String}   dbId 数据主键
     <#list beanColumns as column>
     * @apiSuccess {${column.javaType}} ${column.beanName} ${column.columnComment}
	 </#list>
     * 
     ...
     *     }
     * 
     * @apiSampleRequest http://localhost:8080/mars-core/${modelName}/query?format=json&ignore=true&version=v1
     * 
	 */
	@Override
	public List<? extends Entity> queryAll(HttpServletRequest request, @ParameterAttribute(value = "") ${capitalModelName} entity) { 
     ...
     * 
     * @apiExample 调用示例:
     * 	curl -i http://localhost:8080/mars-core/${modelName}/page?format=json&ignore=true&version=v1&pageNum=2&pageSize=20
     * 
     ...
     *     }
     * 
     * @apiSampleRequest http://localhost:8080/mars-core/${modelName}/page?format=json&ignore=true&version=v1&pageNum=2&pageSize=20
     *  
	 */
	@Override
     ...
     * 
     * @apiExample 调用示例:
     * 	curl -d "code=11&name=abc" -i http://localhost:8080/mars-core/${modelName}/add/command?format=json&ignore=true&version=v1
     * 
	 ...
	 */
	@Override
	public CommandEntity doCommand(@ParameterAttribute(value = "") ${capitalModelName} entity, HttpServletRequest request, @PathVariable String operator) {
