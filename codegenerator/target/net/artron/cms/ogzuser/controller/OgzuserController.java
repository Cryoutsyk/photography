package net.artron.cms.ogzuser.controller;
...
@Slf4j 
@Controller
@RequestMapping("/ogzuser")
public class OgzuserController extends ApplicationController<Ogzuser>  {
	/**
	 * 注入Service类对象.
	 */
	 ...
	 *
	 *
	 * @api {GET} /ogzuser/query 查询地址所有数据
	 * @apiVersion 1.0.0
     * @apiName query
     * @apiGroup Ogzuser
     ...
     * @apiParam {String} code 用户ID，登陆名
     * @apiParam {String} name 用户名称
     * @apiParam {String} displayName 用户显示的名称
     * @apiParam {String} userPassword 用户登陆密码
     * @apiParam {String} orgDbId TBL_CORE_ORG的主键DB_ID
     * @apiParam {String} applicationName applicationName
     * 
     * @apiExample 调用示例:
     * 	curl -i http://localhost:8080/mars-core/ogzuser/query?format=json&ignore=true&version=v1
     * 
     * @apiSuccess {String}   dbId 数据主键
     * @apiSuccess {String} code 用户ID，登陆名
     * @apiSuccess {String} name 用户名称
     * @apiSuccess {String} displayName 用户显示的名称
     * @apiSuccess {String} userPassword 用户登陆密码
     * @apiSuccess {String} orgDbId TBL_CORE_ORG的主键DB_ID
     * @apiSuccess {String} applicationName applicationName
     * 
     ...
     *     }
     * 
     * @apiSampleRequest http://localhost:8080/mars-core/ogzuser/query?format=json&ignore=true&version=v1
     * 
	 */
	@Override
	public List<? extends Entity> queryAll(HttpServletRequest request, @ParameterAttribute(value = "") Ogzuser entity) { 
     ...
     * 
     * @apiExample 调用示例:
     * 	curl -i http://localhost:8080/mars-core/ogzuser/page?format=json&ignore=true&version=v1&pageNum=2&pageSize=20
     * 
     ...
     *     }
     * 
     * @apiSampleRequest http://localhost:8080/mars-core/ogzuser/page?format=json&ignore=true&version=v1&pageNum=2&pageSize=20
     *  
	 */
	@Override
     ...
     * 
     * @apiExample 调用示例:
     * 	curl -d "code=11&name=abc" -i http://localhost:8080/mars-core/ogzuser/add/command?format=json&ignore=true&version=v1
     * 
	 ...
	 */
	@Override
	public CommandEntity doCommand(@ParameterAttribute(value = "") Ogzuser entity, HttpServletRequest request, @PathVariable String operator) {
