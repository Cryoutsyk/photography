package net.artron.cms.pgymtassignjudge.controller;
...
@Slf4j 
@Controller
@RequestMapping("/pgymtassignjudge")
public class PgymtassignjudgeController extends ApplicationController<Pgymtassignjudge>  {
	/**
	 * 注入Service类对象.
	 */
	 ...
	 *
	 *
	 * @api {GET} /pgymtassignjudge/query 查询地址所有数据
	 * @apiVersion 1.0.0
     * @apiName query
     * @apiGroup Pgymtassignjudge
     ...
     * @apiParam {Integer} reviewstate 评审状态,默认0开始评审,结束终评后状态为1评审结束
     * 
     * @apiExample 调用示例:
     * 	curl -i http://localhost:8080/mars-core/pgymtassignjudge/query?format=json&ignore=true&version=v1
     * 
     ...
     * @apiSuccess {Integer} reviewstate 评审状态,默认0开始评审,结束终评后状态为1评审结束
     * 
     ...
     *     }
     * 
     * @apiSampleRequest http://localhost:8080/mars-core/pgymtassignjudge/query?format=json&ignore=true&version=v1
     * 
	 */
	@Override
	public List<? extends Entity> queryAll(HttpServletRequest request, @ParameterAttribute(value = "") Pgymtassignjudge entity) { 
	 ...
	 * @return
	 * 
	 * @api {GET} /pgymtassignjudge/page 分页查询数据
	 * @apiVersion 1.0.0
     * @apiName page
     * @apiGroup Pgymtassignjudge
     ...
     * 
     * @apiExample 调用示例:
     * 	curl -i http://localhost:8080/mars-core/pgymtassignjudge/page?format=json&ignore=true&version=v1&pageNum=2&pageSize=20
     * 
     ...
     *     }
     * 
     * @apiSampleRequest http://localhost:8080/mars-core/pgymtassignjudge/page?format=json&ignore=true&version=v1&pageNum=2&pageSize=20
     *  
	 */
	@Override
     ...
     * 
     * @apiExample 调用示例:
     * 	curl -d "code=11&name=abc" -i http://localhost:8080/mars-core/pgymtassignjudge/add/command?format=json&ignore=true&version=v1
     * 
	 ...
	 */
	@Override
	public CommandEntity doCommand(@ParameterAttribute(value = "") Pgymtassignjudge entity, HttpServletRequest request, @PathVariable String operator) {
