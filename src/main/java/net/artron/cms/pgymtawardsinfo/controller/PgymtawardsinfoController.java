package net.artron.cms.pgymtawardsinfo.controller;
...
@Slf4j 
@Controller
@RequestMapping("/pgymtawardsinfo")
public class PgymtawardsinfoController extends ApplicationController<Pgymtawardsinfo>  {
	/**
	 * 注入Service类对象.
	 */
	 ...
	 *
	 *
	 * @api {GET} /pgymtawardsinfo/query 查询地址所有数据
	 * @apiVersion 1.0.0
     * @apiName query
     * @apiGroup Pgymtawardsinfo
     ...
     *     }
     * 
     * @apiSampleRequest http://localhost:8080/mars-core/pgymtawardsinfo/query?format=json&ignore=true&version=v1
     * 
	 */
	@Override
	public List<? extends Entity> queryAll(HttpServletRequest request, @ParameterAttribute(value = "") Pgymtawardsinfo entity) { 
	 ...
	 * @return
	 * 
	 * @api {GET} /pgymtawardsinfo/page 分页查询数据
	 * @apiVersion 1.0.0
     * @apiName page
     * @apiGroup Pgymtawardsinfo
     ...
     * 
     * @apiExample 调用示例:
     * 	curl -i http://localhost:8080/mars-core/pgymtawardsinfo/page?format=json&ignore=true&version=v1&pageNum=2&pageSize=20
     * 
     ...
     *     }
     * 
     * @apiSampleRequest http://localhost:8080/mars-core/pgymtawardsinfo/page?format=json&ignore=true&version=v1&pageNum=2&pageSize=20
     *  
	 */
	@Override
     ...
     * 
     * @apiExample 调用示例:
     * 	curl -d "code=11&name=abc" -i http://localhost:8080/mars-core/pgymtawardsinfo/add/command?format=json&ignore=true&version=v1
     * 
	 ...
	 */
	@Override
	public CommandEntity doCommand(@ParameterAttribute(value = "") Pgymtawardsinfo entity, HttpServletRequest request, @PathVariable String operator) {
