...
@Service(value = "Pgymtmstjde.delete")
public class PgymtmstjdeDeleteCommand extends DeleteCommand<Pgymtmstjde, String> {
	/**
	 * 注入Service类对象.
	 */
	...
	public Pgymtmstjde doExecuteService(Pgymtmstjde entity) throws MarsException {
		if (log.isDebugEnabled()) {
			log.debug("{} Pgymtmstjde.delete ", Mars.LOG_PRE);
		}
