...
@Service(value = "Pgymtawards.update")
public class PgymtawardsUpdateCommand extends UpdateCommand<Pgymtawards, String> {
    /**
	 * 注入Service类对象.
	 */
	...
	public Pgymtawards doExecuteService(Pgymtawards entity) throws MarsException {
		if (log.isDebugEnabled()) {
			log.debug("{} Pgymtawards.update ", Mars.LOG_PRE);
		}
