...
@Service(value = "Pgymtawards.delete")
public class PgymtawardsDeleteCommand extends DeleteCommand<Pgymtawards, String> {
	/**
	 * 注入Service类对象.
	 */
	...
	public Pgymtawards doExecuteService(Pgymtawards entity) throws MarsException {
		if (log.isDebugEnabled()) {
			log.debug("{} Pgymtawards.delete ", Mars.LOG_PRE);
		}
