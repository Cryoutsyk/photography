...
@Service(value = "Pgymstscore.update")
public class PgymstscoreUpdateCommand extends UpdateCommand<Pgymstscore, String> {
    /**
	 * 注入Service类对象.
	 */
	...
	public Pgymstscore doExecuteService(Pgymstscore entity) throws MarsException {
		if (log.isDebugEnabled()) {
			log.debug("{} Pgymstscore.update ", Mars.LOG_PRE);
		}
