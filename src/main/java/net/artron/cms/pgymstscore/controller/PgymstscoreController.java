package net.artron.cms.pgymstscore.controller;
...
@Slf4j 
@Controller
@RequestMapping("/pgymstscore")
public class PgymstscoreController extends ApplicationController<Pgymstscore>  {
	/**
	 * 注入Service类对象.
	 */
	 ...
	 *
	 *
	 * @api {GET} /pgymstscore/query 查询地址所有数据
	 * @apiVersion 1.0.0
     * @apiName query
     * @apiGroup Pgymstscore
     ...
     * @apiParam {Integer} score 得分,
     * 
     * @apiExample 调用示例:
     * 	curl -i http://localhost:8080/mars-core/pgymstscore/query?format=json&ignore=true&version=v1
     * 
     ...
     *     }
     * 
     * @apiSampleRequest http://localhost:8080/mars-core/pgymstscore/query?format=json&ignore=true&version=v1
     * 
	 */
	@Override
	public List<? extends Entity> queryAll(HttpServletRequest request, @ParameterAttribute(value = "") Pgymstscore entity) { 
	 ...
	 * @return
	 * 
	 * @api {GET} /pgymstscore/page 分页查询数据
	 * @apiVersion 1.0.0
     * @apiName page
     * @apiGroup Pgymstscore
     ...
     * 
     * @apiExample 调用示例:
     * 	curl -i http://localhost:8080/mars-core/pgymstscore/page?format=json&ignore=true&version=v1&pageNum=2&pageSize=20
     * 
     ...
     *     }
     * 
     * @apiSampleRequest http://localhost:8080/mars-core/pgymstscore/page?format=json&ignore=true&version=v1&pageNum=2&pageSize=20
     *  
	 */
	@Override
     ...
     * 
     * @apiExample 调用示例:
     * 	curl -d "code=11&name=abc" -i http://localhost:8080/mars-core/pgymstscore/add/command?format=json&ignore=true&version=v1
     * 
	 ...
	 */
	@Override
	public CommandEntity doCommand(@ParameterAttribute(value = "") Pgymstscore entity, HttpServletRequest request, @PathVariable String operator) {
