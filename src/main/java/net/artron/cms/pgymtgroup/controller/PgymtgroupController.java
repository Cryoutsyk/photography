package net.artron.cms.pgymtgroup.controller;
...
@Slf4j 
@Controller
@RequestMapping("/pgymtgroup")
public class PgymtgroupController extends ApplicationController<Pgymtgroup>  {
	/**
	 * 注入Service类对象.
	 */
	 ...
	 *
	 *
	 * @api {GET} /pgymtgroup/query 查询地址所有数据
	 * @apiVersion 1.0.0
     * @apiName query
     * @apiGroup Pgymtgroup
     ...
     * @apiParam {String} name 分组名称,分组名称最多10个字
     * 
     * @apiExample 调用示例:
     * 	curl -i http://localhost:8080/mars-core/pgymtgroup/query?format=json&ignore=true&version=v1
     * 
     ...
     * @apiSuccess {String} name 分组名称,分组名称最多10个字
     * 
     ...
     *     }
     * 
     * @apiSampleRequest http://localhost:8080/mars-core/pgymtgroup/query?format=json&ignore=true&version=v1
     * 
	 */
	@Override
	public List<? extends Entity> queryAll(HttpServletRequest request, @ParameterAttribute(value = "") Pgymtgroup entity) { 
	 ...
	 * @return
	 * 
	 * @api {GET} /pgymtgroup/page 分页查询数据
	 * @apiVersion 1.0.0
     * @apiName page
     * @apiGroup Pgymtgroup
     ...
     * 
     * @apiExample 调用示例:
     * 	curl -i http://localhost:8080/mars-core/pgymtgroup/page?format=json&ignore=true&version=v1&pageNum=2&pageSize=20
     * 
     ...
     *     }
     * 
     * @apiSampleRequest http://localhost:8080/mars-core/pgymtgroup/page?format=json&ignore=true&version=v1&pageNum=2&pageSize=20
     *  
	 */
	@Override
     ...
     * 
     * @apiExample 调用示例:
     * 	curl -d "code=11&name=abc" -i http://localhost:8080/mars-core/pgymtgroup/add/command?format=json&ignore=true&version=v1
     * 
	 ...
	 */
	@Override
	public CommandEntity doCommand(@ParameterAttribute(value = "") Pgymtgroup entity, HttpServletRequest request, @PathVariable String operator) {
