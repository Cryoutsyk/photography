package net.artron.cms.dict.controller;
...
@Controller
@RequestMapping("/dict")
public class DictController extends ApplicationController<Dict>  {
	/**
	 * 注入Service类对象.
	 */
     ...
     * @apiParam {Double} sort 排序（升序）
     * @apiParam {String} parentId 父级编号
     * @apiParam {String} createBy 创建者
     * @apiParam {java.util.Date} createDate 创建时间
     * @apiParam {String} updateBy 更新者
     * @apiParam {java.util.Date} updateDate 更新时间
     * @apiParam {String} remarks 备注信息
     * @apiParam {String} delFlag 删除标记
     * 
     * @apiExample 调用示例:
     * 	curl -i http://localhost:8080/mars-core/dict/query?format=json&ignore=true&version=v1
     * 
     * @apiSuccess {String}   dbId 数据主键
     * @apiSuccess {String} value 数据值
     * @apiSuccess {String} label 标签名
     * @apiSuccess {String} type 类型
     * @apiSuccess {String} description 描述
     * @apiSuccess {Double} sort 排序（升序）
     * @apiSuccess {String} parentId 父级编号
     * @apiSuccess {String} createBy 创建者
     * @apiSuccess {java.util.Date} createDate 创建时间
     * @apiSuccess {String} updateBy 更新者
     * @apiSuccess {java.util.Date} updateDate 更新时间
     * @apiSuccess {String} remarks 备注信息
     * @apiSuccess {String} delFlag 删除标记
     * 
     ...
     *     }
     * 
     * @apiSampleRequest http://localhost:8080/mars-core/dict/query?format=json&ignore=true&version=v1
     * 
	 */
	@Override
	public List<? extends Entity> queryAll(HttpServletRequest request, @ParameterAttribute(value = "") Dict entity) { 
     ...
     * 
     * @apiExample 调用示例:
     * 	curl -i http://localhost:8080/mars-core/dict/page?format=json&ignore=true&version=v1&pageNum=2&pageSize=20
     * 
     ...
     *     }
     * 
     * @apiSampleRequest http://localhost:8080/mars-core/dict/page?format=json&ignore=true&version=v1&pageNum=2&pageSize=20
     *  
	 */
	@Override
     ...
     * 
     * @apiExample 调用示例:
     * 	curl -d "code=11&name=abc" -i http://localhost:8080/mars-core/dict/add/command?format=json&ignore=true&version=v1
     * 
	 ...
	 */
	@Override
	public CommandEntity doCommand(@ParameterAttribute(value = "") Dict entity, HttpServletRequest request, @PathVariable String operator) {
