package net.artron.cms.pic.controller;
...
@Controller
@RequestMapping("/pic")
public class PicController extends ApplicationController<Pic>  {
	/**
	 * 注入Service类对象.
	 */
     ...
     * @apiParam {String} urlId 跳转的id值
     * 
     * @apiExample 调用示例:
     * 	curl -i http://localhost:8080/mars-core/pic/query?format=json&ignore=true&version=v1
     * 
     * @apiSuccess {String}   dbId 数据主键
     * @apiSuccess {String} imgUrl 头像
     * @apiSuccess {String} urlId 跳转的id值
     * 
     ...
     *     }
     * 
     * @apiSampleRequest http://localhost:8080/mars-core/pic/query?format=json&ignore=true&version=v1
     * 
	 */
	@Override
	public List<? extends Entity> queryAll(HttpServletRequest request, @ParameterAttribute(value = "") Pic entity) { 
     ...
     * 
     * @apiExample 调用示例:
     * 	curl -i http://localhost:8080/mars-core/pic/page?format=json&ignore=true&version=v1&pageNum=2&pageSize=20
     * 
     ...
     *     }
     * 
     * @apiSampleRequest http://localhost:8080/mars-core/pic/page?format=json&ignore=true&version=v1&pageNum=2&pageSize=20
     *  
	 */
	@Override
     ...
     * 
     * @apiExample 调用示例:
     * 	curl -d "code=11&name=abc" -i http://localhost:8080/mars-core/pic/add/command?format=json&ignore=true&version=v1
     * 
	 ...
	 */
	@Override
	public CommandEntity doCommand(@ParameterAttribute(value = "") Pic entity, HttpServletRequest request, @PathVariable String operator) {
	...
	* @throws 
	*/
	@RequestMapping(value = "open/queryAll", method = RequestMethod.GET)
	@ResponseBody
